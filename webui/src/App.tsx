...
const SIDEBAR_STORAGE_KEY = "vidtoryagent-webui.sidebar";
const COMPLETED_RUNS_STORAGE_KEY = "vidtoryagent-webui.sidebar.completed-runs.v1";
const RESTART_STARTED_KEY = "vidtoryagent-webui.restartStartedAt";
