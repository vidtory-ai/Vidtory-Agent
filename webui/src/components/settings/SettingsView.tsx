...
const LOCAL_PREFS_STORAGE_KEY = "vidtoryagent-webui.settings-preferences";
          ...
          <div className="flex flex-col gap-4 px-5 py-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <div className="text-[12px] font-medium text-muted-foreground">Vidtory-Agent</div>
        ...
        <SettingsGroup>
          ...
          >
            <a
              ...
              href="https://github.com/vidtory-ai/Vidtory-Agent/blob/main/docs/configuration.md"
              target="_blank"
              rel="noreferrer"
            >
