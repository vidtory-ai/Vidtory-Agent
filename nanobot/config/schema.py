...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.vidtoryagent/workspace"
    ...
    bot_name: str = "Vidtory-Agent"  # Display name shown in CLI prompts (e.g. "{name} is thinking...")
...
class ProvidersConfig(Base):
    ...
    vidtory: ProviderConfig = Field(default_factory=ProviderConfig)  # Vidtory AI Provider
